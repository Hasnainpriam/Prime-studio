        ...
        <>
            <div className="bg-white pb-6 sm:pb-8 lg:pb-12">
                <div className="max-w-screen-2xl px-6 md:px-12 mx-auto">
                    <section className="min-h-96 flex justify-center items-center flex-1 shrink-0  overflow-hidden shadow-lg rounded-lg relative py-16 md:py-20 xl:py-36">

                        <img src="https://images.unsplash.com/photo-1615212049275-95561aebe1b4?auto=format&q=75&fit=crop&w=1500" loading="lazy" alt="" className="w-full h-full object-cover object-center absolute inset-0" />

                        <div className=" bg-slate-400 mix-blend-multiply absolute inset-0"></div>

                        <div className="sm:max-w-xl flex flex-col items-center relative p-4">
                            <p className=" text-white text-lg sm:text-xl text-center mb-4 md:mb-8">I Shoot Happiness</p>
                            <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-8 md:mb-12">Your Story Is Waiting To Be Told</h1>

                            <div className="w-full flex flex-col sm:flex-row sm:justify-center gap-2.5">
                                <Link to='/pricing' className="inline-block bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Hire Now</Link>

                                <Link to='/bigallery' className="inline-block bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Take tour</Link>
                            </div>
                        </div>
                    ...
                    <div className="mt-12 flex flex-col md:flex-row justify-between items-center gap-8">
                        <div className="w-64 h-12 flex border rounded-lg overflow-hidden divide-x">
                            <Link to='/' className="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Fashion</Link>
                            <Link to='/' className="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Weeding</Link>
                            <Link to='/' className="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Family</Link>
                        </div>
                        ...
                        <div className="flex justify-center lg:justify-start items-center gap-4">
                            ...
                            <div className="flex gap-4">
                                <Link to='/' className="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
